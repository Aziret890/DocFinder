...
import stationar from "@/components/svg/stationar.svg";
import p from "@/components/svg/p.svg";
import card from "@/components/svg/card.svg";
import diarnostic from "@/components/svg/diagnostic.svg";
import analiz from "@/components/svg/analiz.svg";
import deti from "@/components/svg/deti.svg";
import time from "@/components/svg/24/7.svg";
